...
function ExpandExport() {
  ...
  return (
    <>
    <div className=" w-full min-h-screen overflow-x-hidden flex  flex-col bg-[url('../components/image/ab.jpg')]  bg-cover bg-no-repeat items-start gap-8 pt-20 justify-start  ">
      <ToastContainer />
      <Head>
